...
data_dir = "/datahub/rawdata/tandeng/mRNA_imaging/mRNA_confocal_hamamatsu-60X-TIRF/20200321";
ret_dir = "/datahub/rawdata/tandeng/mRNA_imaging/mRNA_confocal_hamamatsu-60X-TIRF/20200321_result/output";
...
function playing(s)
	...
	@time img = load(File(format"TIFF","$data_dir/HE7-1NLS-85uw-const_1_s$s.ome.tiff"));
	GC.gc()
	println("Load done")
    t_len = size(img)[3]÷20
