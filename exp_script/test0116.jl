...
data_dir = "/datahub/rawdata/tandeng/mRNA_imaging/mRNA_confocal_III/20210116";
ret_dir = "/datahub/rawdata/tandeng/mRNA_imaging/mRNA_confocal_III/2021016_result";
...
function playing(s)
	...
	for index in 1:length(longlived_labels)
        ...
        save("$ret_dir/d16s$(s)-$index.jld", "threshold", nucleus_th, "normal", nor_para,
